...
<img src="https://picgo-1300337066.cos.ap-shanghai.myqcloud.com/20220401170154.png" alt="[设备连接图]" width="450" div align=center/>  
## shadowsocks-libev
### 安装配置ss
```c
sudo apt-get update
...
4. 保存设置后重启路由器
5. 通过路由器连接上网，测试可以访问[www.google.com](https://www.google.com/)  
